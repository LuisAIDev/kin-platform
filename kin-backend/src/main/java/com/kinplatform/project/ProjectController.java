...
public class ProjectController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ProjectResponse> getById(Authentication auth, @PathVariable UUID id) {
        var userId = getAuthenticatedUserId(auth);
    ...
    public ResponseEntity<ProjectResponse> update(
            Authentication auth, @PathVariable UUID id, @Valid @RequestBody UpdateProjectRequest request) {
        var userId = getAuthenticatedUserId(auth);
