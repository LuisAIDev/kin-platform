...
class OpenAIProviderTest {
    ...
    void setUp() {
        ...
        provider = new OpenAIProvider(builder, "gpt-4o-mini");
    }
    ...
    @Test
    void providerName_deberiaSerOpenAI() {
    ...
    @Test
    void generateBlocking_conFallo_deberiaDevolverNull() {
        stubPrompt();
        when(spec.call()).thenReturn(callSpec);
    ...
    void generateStream_deberiaEmitirLosTokens() {
        ...
        when(streamSpec.content()).thenReturn(Flux.just("tok"));
